...
[![Maven Central](https://img.shields.io/maven-central/v/com.ours_privacy.api/ours-privacy-kotlin)](https://central.sonatype.com/artifact/com.ours_privacy.api/ours-privacy-kotlin/0.3.0)
[![javadoc](https://javadoc.io/badge2/com.ours_privacy.api/ours-privacy-kotlin/0.3.0/javadoc.svg)](https://javadoc.io/doc/com.ours_privacy.api/ours-privacy-kotlin/0.3.0)
...
The REST API documentation can be found on [docs.oursprivacy.com](https://docs.oursprivacy.com). KDocs are available on [javadoc.io](https://javadoc.io/doc/com.ours_privacy.api/ours-privacy-kotlin/0.3.0).
...
```kotlin
implementation("com.ours_privacy.api:ours-privacy-kotlin:0.3.0")
```
