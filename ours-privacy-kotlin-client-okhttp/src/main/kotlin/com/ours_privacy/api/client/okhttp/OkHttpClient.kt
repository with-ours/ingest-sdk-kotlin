...
import com.ours_privacy.api.core.http.HttpRequestBody
import com.ours_privacy.api.core.http.HttpResponse
import com.ours_privacy.api.errors.OursPrivacyIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw OursPrivacyIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("OURS_PRIVACY_LOG")?.lowercase()) {
