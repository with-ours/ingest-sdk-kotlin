...
/**
 * Send multiple `/track`-shaped events in a single request. The top-level token is authorized once
 * for the full batch. Each batch row must include `distinctId`, and mixed validation or queue
