...
private constructor(
    ...
    /**
     * User properties to associate with this user. The existing user properties will be updated.
     * And all future events will have these properties associated with them.
     *
     * @throws OursPrivacyInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    class Builder internal constructor() {
        ...
        /**
         * User properties to associate with this user. The existing user properties will be
         * updated. And all future events will have these properties associated with them.
         */
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun userProperties(): UserProperties = userProperties.getRequired("userProperties")
        ...
        class Builder internal constructor() {
            ...
            private var userProperties: JsonField<UserProperties>? = null
            ...
            fun userProperties(userProperties: UserProperties) =
                userProperties(JsonField.of(userProperties))
            ...
            fun build(): Body =
                Body(
                    ...
                    checkRequired("userProperties", userProperties),
                    defaultProperties,
                    email,
                    externalId,
                    identityContext,
        ...
        override fun toString() =
            "Body{token=$token, userProperties=$userProperties, defaultProperties=$defaultProperties, email=$email, externalId=$externalId, identityContext=$identityContext, userId=$userId, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
         ...
         *
         * Unlike [_efTransactionId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("_ef_transaction_id")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder._efTransactionId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.basisCid] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.oppref] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    private constructor(
        ...
        /**
         * The Everflow affiliate Click (Transaction) ID, captured from the `_ef_transaction_id` URL
         * parameter. Ex: ef_click_abc123
         *
         * @throws OursPrivacyInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
         */
         ...
         * landing pages (the OpenAI Pixel also stores it in a `__oppref` cookie). Sent to OpenAI
         * Ads on Conversions API events for attribution. Ex: oppref_abc
         *
         * @throws OursPrivacyInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
         */
