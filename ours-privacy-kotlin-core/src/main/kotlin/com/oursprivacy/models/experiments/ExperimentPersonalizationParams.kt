...
/**
 * Return a visitor's active personalization assignments and accumulated personalization properties.
 * Read-only and never records an impression. `personalizations` lists the personalization
 * experiences the visitor is currently assigned to; `properties` returns the visitor traits your
 * personalization property rules have accumulated, ready to use in server-rendered copy or
 * targeting. Both are empty for a visitor who has not matched anything yet.
 */
class ExperimentPersonalizationParams
private constructor(
    ...
    /** A builder for [ExperimentPersonalizationParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(experimentPersonalizationParams: ExperimentPersonalizationParams) =
            apply {
                body = experimentPersonalizationParams.body.toBuilder()
                additionalHeaders = experimentPersonalizationParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    experimentPersonalizationParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ExperimentPersonalizationParams].
         *
         ...
         */
        fun build(): ExperimentPersonalizationParams =
            ExperimentPersonalizationParams(
                body.build(),
    ...
    private constructor(
        ...
        ) : this(token, visitorId, mutableMapOf())
        ...
        internal fun validity(): Int =
            (if (token.asKnown() == null) 0 else 1) + (if (visitorId.asKnown() == null) 0 else 1)
        ...
        private val hashCode: Int by lazy { Objects.hash(token, visitorId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{token=$token, visitorId=$visitorId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExperimentPersonalizationParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ExperimentPersonalizationParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
