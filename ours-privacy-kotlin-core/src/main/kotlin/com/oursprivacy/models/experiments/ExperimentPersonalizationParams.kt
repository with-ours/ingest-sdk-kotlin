 ...
 * impression. Personalizations are populated by the event-driven rule engine — until that ships,
 * this endpoint returns an empty list for every visitor, which is the correct fail-closed behavior
 * (no false positives).
 */
