...
interface ExperimentServiceAsync {
     ...
     * properties. Read-only and never records an impression. `personalizations` lists the
     * personalization experiences the visitor is currently assigned to; `properties` returns the
     * visitor traits your personalization property rules have accumulated, ready to use in
     * server-rendered copy or targeting. Both are empty for a visitor who has not matched anything
     * yet.
     */
